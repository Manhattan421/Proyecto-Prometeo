...
<body>
    ...
    <table border="1" cellpadding="8" cellspacing="0">
        ...
        <?php
        $sql = "SELECT i.id, i.Título, i.Descripción, i.Estado, i.Prioridad, i.Categoria, i.Subcategoria, i.FechaCreación, u.Nombre  
                FROM incidencias i 
    ...
    echo "<td>" . htmlspecialchars($fila['Subcategoria']) . "</td>";
