...
if (isset($_POST['id'])) {
    ...
    $sql_select = "SELECT i.Título, i.Descripción, i.Prioridad, i.Categoria, i.Subcategoria, i.FechaCreación, i.IdUsuario, u.Nombre 
                   FROM incidencias i 
    ...
    if ($resultado->num_rows === 1) {
        ...
        $sql_insert = "INSERT INTO historialIncidencia 
            (Título, Descripción, Prioridad, Categoria, Subcategoria, FechaCreación, IdUsuario, NombreUsuario, FechaCierre)
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, NOW())";
	...
	registrarLog($_SESSION['usuario'], "Cerró incidencia: " . $incidencia['Título']);				
